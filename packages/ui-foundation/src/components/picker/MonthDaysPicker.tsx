...
export interface MonthDaysPickerProps {
    value?: string | string[]
    onChange: (value: string) => void
    disabled?: boolean
}

export const MonthDaysPicker = ({ value, onChange, disabled = false }: MonthDaysPickerProps) => {
    ...
    const [selected, setSelected] = useState<string[]>(sortDays(parseValue(value)))
    ...
    const renderChip = (valueToken: string, label: string) => {
