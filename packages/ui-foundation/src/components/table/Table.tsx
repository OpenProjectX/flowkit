...
export interface TableViewOnlyProps {
    columns: string[]
    rows: Array<Record<string, any>>
    sx?: SxProps<Theme>
}

export const TableViewOnly = ({ columns, rows, sx }: TableViewOnlyProps) => {
    // Helper function to safely render cell content
    const renderCellContent = (key: string, row: Record<string, any>): ReactNode => {
